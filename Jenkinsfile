...
//  def mvnCmd = "${mvnHome}bin/mvn"
  ...
  stage('Build') {
    ...
    sh "${mvnCmd} clean install -DskipTests=true -f ${pomFileLocation} -Dhttps.proxyHost=172.31.16.199  -Dhttps.proxyPort=80 -Dhttp.proxyHost=172.31.16.199  -Dhttp.proxyPort=80" }

  stage('Unit Test') {

     sh "${mvnCmd} test -f ${pomFileLocation} -Dhttps.proxyHost=172.31.16.199  -Dhttps.proxyPort=80 -Dhttp.proxyHost=172.31.16.199  -Dhttp.proxyPort=80"}
